...
execute if block ~ ~ ~ #rc_lib:special run function rc_lib:rc/z/special
execute unless block ~ ~ ~ #rc_lib:air unless block ~ ~ ~ #rc_lib:special run function rc_lib:rc/z/end
